...
function validateRegistro(id, pass, pass2, nombre, departamento){
    ...
    if (!validatePassLogin(pass2)) {
        errores.push("pass2");
        msjDanger("Formato de pass 2 incorrecto - Solo admite letras y numeros - Ha de contener al menos 5 caracteres");
    }
    if(pass != pass2){
        errores.push("pass2");
    ...
    if (!validateNombre(nombre)) {
        errores.push("pass2");
        msjDanger("Formato de nombre incorrecto - Solo admite letras y espacios - Ha de contener al menos 3 caracteres");
    }
    if (!validateDepartamento(departamento)) {
        errores.push("pass2");
        msjDanger("Formato de nombre incorrecto - Solo admite letras y espacios - Ha de contener al menos 5 caracteres");
    }
